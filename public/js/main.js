...
import { mockJobs, mockCategories } from '../src/data/mockData.js';
...
function initEventListeners() {
  ...
  // Job actions
  document.getElementById('viewAllJobsBtn')?.addEventListener('click', () => window.location.href = '/jobs');
  document.getElementById('viewAllJobsMobileBtn')?.addEventListener('click', () => window.location.href = '/jobs');
